...
public class JwtService {
    ...
    public String extractUsername(String token) {
        return extractClaim(token, Claims::getSubject);//extrae el email aqui
    }
    ...
    public  String generateToken(
        ...
        return  Jwts
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 24)) //expiracion del token en 24 horas
